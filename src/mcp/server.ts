  ...
  const server = new McpServer(
    { name: "watchdog", version: "0.0.1" },
    {
      instructions: [
        ...
        "Attribute child-owned nodes only when ownerAgent can be resolved; otherwise keep work root-owned rather than guessing.",
  ...
  server.registerTool(
    "watchdog_execution",
    {
      ...
      description: [
        ...
        "For child work, set ownerAgent only when Watchdog exposes a resolvable child identity; never guess an association.",
